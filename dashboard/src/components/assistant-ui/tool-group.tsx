...
const toolGroupVariants = cva("aui-tool-group-root group/tool-group w-full", {
  variants: {
    variant: {
      outline: "rounded-lg border border-oklch(0.92 0.004 286.32) py-3 dark:border-oklch(1 0 0 / 10%)",
      ghost: "",
      muted: "border-oklch(0.552 0.016 285.938)/30 bg-oklch(0.967 0.001 286.375)/30 rounded-lg border border-oklch(0.92 0.004 286.32) py-3 dark:border-oklch(0.705 0.015 286.067)/30 dark:bg-oklch(0.274 0.006 286.033)/30 dark:border-oklch(1 0 0 / 10%)",
    },
  },
  ...
  return (
    <CollapsibleTrigger
      ...
      className={cn(
        ...
        "group-data-[variant=ghost]/tool-group-root:text-oklch(0.552 0.016 285.938) group-data-[variant=ghost]/tool-group-root:hover:text-oklch(0.141 0.005 285.823) group-data-[variant=ghost]/tool-group-root:py-1.5 dark:group-data-[variant=ghost]/tool-group-root:text-oklch(0.705 0.015 286.067) dark:group-data-[variant=ghost]/tool-group-root:hover:text-oklch(0.985 0 0)",

      ...
      <div className="mx-auto flex min-h-8 w-max items-center gap-2 px-0.5">
        {suggestions.map((suggestion, idx) => (
          <ThreadPrimitive.Suggestion
            key={idx}
            className="aui-thread-followup-suggestion bg-oklch(1 0 0) hover:bg-oklch(0.967 0.001 286.375)/80 rounded-full border border-oklch(0.92 0.004 286.32) px-3 py-1 text-sm whitespace-nowrap transition-colors ease-in dark:bg-oklch(0.141 0.005 285.823) dark:hover:bg-oklch(0.274 0.006 286.033)/80 dark:border-oklch(1 0 0 / 10%)"

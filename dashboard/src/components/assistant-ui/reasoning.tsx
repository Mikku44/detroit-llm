...
const reasoningVariants = cva("aui-reasoning-root mb-4 w-full", {
  variants: {
    variant: {
      outline: "rounded-lg border border-oklch(0.92 0.004 286.32) px-3 py-2 dark:border-oklch(1 0 0 / 10%)",
      ghost: "",
      muted: "bg-oklch(0.967 0.001 286.375)/50 rounded-lg px-3 py-2 dark:bg-oklch(0.274 0.006 286.033)/50",
    },
  },
  defaultVariants: {
    variant: "outline",
...
function ReasoningTrigger({
  ...
  return (
    <CollapsibleTrigger
      ...
      className={cn(
        "aui-reasoning-trigger group/trigger text-oklch(0.552 0.016 285.938) hover:text-oklch(0.141 0.005 285.823) flex max-w-[75%] origin-left items-center gap-2 py-1.5 text-sm transition-[color,scale] active:scale-[0.98] dark:text-oklch(0.705 0.015 286.067) dark:hover:text-oklch(0.985 0 0)",
        className,
      )}
      {...props}
    >
...
function ReasoningContent({
  ...
  return (
    <CollapsibleContent
      ...
      className={cn(
        "aui-reasoning-content text-oklch(0.552 0.016 285.938) relative overflow-hidden text-sm outline-none dark:text-oklch(0.705 0.015 286.067)",

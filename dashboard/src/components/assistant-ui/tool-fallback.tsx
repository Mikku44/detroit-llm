...
function ToolFallbackDuration({
  ...
  return (
    <span
      ...
      className={cn(
        "aui-tool-fallback-duration text-oklch(0.552 0.016 285.938) text-xs tabular-nums dark:text-oklch(0.705 0.015 286.067)",
        className,
      )}
      {...props}
    >
...
function ToolFallbackTrigger({
  ...
  return (
    <CollapsibleTrigger
      ...
      className={cn(
        "aui-tool-fallback-trigger group/trigger text-oklch(0.552 0.016 285.938) hover:text-oklch(0.141 0.005 285.823) flex w-fit origin-left items-center gap-2 py-1.5 text-sm transition-[color,scale] active:scale-[0.98] dark:text-oklch(0.705 0.015 286.067) dark:hover:text-oklch(0.985 0 0)",
        className,
      )}
      {...props}
    >
      <Icon
        ...
        className={cn(
          ...
          isCancelled && "text-oklch(0.552 0.016 285.938) dark:text-oklch(0.705 0.015 286.067)",
      ...
      <span
        ...
        className={cn(
          ...
          isCancelled && "text-oklch(0.552 0.016 285.938) line-through dark:text-oklch(0.705 0.015 286.067)",
        )}
      >
        <span>
          {label}: <b>{toolName}</b>
...
function ToolFallbackArgs({
  ...
  return (
    <div
      ...
      {...props}
    >
      <pre className="aui-tool-fallback-args-value bg-oklch(0.967 0.001 286.375)/50 text-oklch(0.141 0.005 285.823)/90 rounded-md p-2.5 text-xs whitespace-pre-wrap dark:bg-oklch(0.274 0.006 286.033)/50 dark:text-oklch(0.985 0 0)/90">
        {argsText}
      </pre>
    </div>
  );
...
function ToolFallbackResult({
  ...
  return (
    <div
      ...
      {...props}
    >
      <p className="aui-tool-fallback-result-header text-oklch(0.552 0.016 285.938) text-xs font-medium dark:text-oklch(0.705 0.015 286.067)">
        Result:
      </p>
      <pre className="aui-tool-fallback-result-content bg-oklch(0.967 0.001 286.375)/50 text-oklch(0.141 0.005 285.823)/90 mt-1 rounded-md p-2.5 text-xs whitespace-pre-wrap dark:bg-oklch(0.274 0.006 286.033)/50 dark:text-oklch(0.985 0 0)/90">
...
function ToolFallbackError({
  ...
  return (
    <div
      ...
      {...props}
    >
      <p className="aui-tool-fallback-error-header text-oklch(0.552 0.016 285.938) font-semibold dark:text-oklch(0.705 0.015 286.067)">
        {headerText}
      </p>
      <p className="aui-tool-fallback-error-reason text-oklch(0.552 0.016 285.938) dark:text-oklch(0.705 0.015 286.067)">
        {errorText}
      </p>
    </div>
  );
  ...
  if (confirming) {
    ...
    return (
      ...
      >
        ...
        {confirmDescription && (
          <p className="aui-tool-fallback-approval-confirm-description text-oklch(0.552 0.016 285.938) dark:text-oklch(0.705 0.015 286.067)">
            {confirmDescription}
          </p>
        )}
        {confirming.grants && confirming.grants.length > 0 && (
          <ul className="aui-tool-fallback-approval-confirm-grants flex flex-col gap-1">
            {confirming.grants.map((grant) => (
              <li key={grant}>
                <code className="aui-tool-fallback-approval-confirm-grant bg-oklch(0.967 0.001 286.375) rounded px-1.5 py-0.5 text-xs dark:bg-oklch(0.274 0.006 286.033)">
                  {grant}
                </code>
              </li>
            ))}

      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              "group/sidebar-wrapper  flex min-h-svh w-full max-h-screen overflow-hidden has-[[data-variant=inset]]:bg-oklch(0.985 0 0) dark:has-[[data-variant=inset]]:bg-oklch(0.21 0.006 285.885)",
              className
            )}
            ref={ref}
            {...props}
  ...
  (
    ...
    return (
      <div
        ...
        data-side={side}
      >
        {/* Desktop Gap Spacer with Smooth Cubic Bezier Transition */}
        <div
          className={cn(
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn(
        "absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all ease-in-out after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] hover:after:bg-oklch(0.92 0.004 286.32) group-data-[side=left]:-right-4 group-data-[side=right]:left-0 sm:flex dark:hover:after:bg-oklch(1 0 0 / 10%)",
...
/* Updated SidebarInset with matching 200ms transition */
...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        "relative flex w-full flex-1 flex-col bg-oklch(1 0 0) transition-[margin,padding,width,border-radius] duration-200 ease-in-out dark:bg-oklch(0.141 0.005 285.823)",

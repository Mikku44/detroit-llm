...
const AIArtifact = ({
  ...
  return (
    <div
      className={cn(
        "w-full overflow-hidden rounded-xl border border-zinc-800 bg-zinc-900/80",
        className
      )}
    >
      <div className="flex items-center gap-2 border-b border-zinc-800 px-2 py-1.5">
        <span className="min-w-0 truncate px-1 text-xs font-medium text-zinc-200">
          {title}
        </span>

        {available.length > 1 && (
          <div className="ml-auto flex items-center gap-0.5 rounded-lg bg-zinc-800 p-0.5">

        ...
        {items.map((item, i) => {
          ...
          return (
            <motion.div
              ...
              className="absolute top-1/2 left-1/2 w-max max-w-[100vw] overflow-hidden rounded-2xl border border-oklch(0.92 0.004 286.32) bg-oklch(1 0 0) shadow-lg dark:border-oklch(1 0 0 / 10%) dark:bg-oklch(0.141 0.005 285.823)"
            ...
            >
              ...
              <div
                className={cn(
                  "flex aspect-16/10 w-full flex-col rounded-xl bg-oklch(1 0 0) transition-all duration-200 dark:bg-oklch(0.141 0.005 285.823)",
                  isHovered && "shadow-xl",
              ...
              >
                ...
                <a
                  ...
                  className={cn(
                    "flex items-center justify-center gap-1 bg-oklch(1 0 0)/95 p-3 text-decoration-none text-inherit backdrop-blur-sm transition-colors duration-200 dark:bg-oklch(0.141 0.005 285.823)/95"
                  )}
                  href={item.href}
                ...
                >
                  <img
                    ...
                    src={item.avatar}
                    style={{
                      boxShadow: "0 1px var(--border-secondary, #e0e0e0)",
                    }}
                    width={20}
                  />
                  <span className="font-medium text-oklch(0.141 0.005 285.823) text-sm leading-none dark:text-oklch(0.985 0 0)">
                    {item.name}
                  </span>
                  <span className="font-normal text-oklch(0.141 0.005 285.823)/70 text-sm dark:text-oklch(0.985 0 0)/70">
                    {item.handle}
                  </span>
                </a>
              </div>

...
const MODEL_META: Record<string, ModelMeta> = {
  ...
  'muse-spark-1.3': {
    name: 'Muse Spark 1.3',
    desc: 'Text + Image + Video + PDF — Meta agentic coding, 1M context',
    badges: ['text', 'image', 'video', 'reasoning'],
  },
  'muse-spark-1.3-contributor': {
    name: 'Muse Spark 1.3 Contributor',
    desc: 'Text + Image + Video + PDF — discounted contributor tier',
    badges: ['text', 'image', 'video', 'reasoning'],
  },
  'muse-spark-1.2': {
    name: 'Muse Spark 1.2',
    desc: 'Text + Image + Video + PDF — Meta agentic coding',
    badges: ['text', 'image', 'video', 'reasoning'],
  },
  ...
  'muse-spark-1.1': {
    name: 'Muse Spark 1.1',
    desc: 'Text + Image + Video + PDF — Meta earlier checkpoint',
    badges: ['text', 'image', 'video', 'reasoning'],
  },
  'gemini-2.5-flash': {

  ...
  return (
    <MessageScrollerProvider>
      <div className="relative flex flex-col gap-4">
        <Card className="mx-auto h-[calc(100vh-8rem)] w-full gap-0">
            ...
            <CardAction>
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button variant="outline" size="icon" aria-label="Reset conversation" onClick={() => setMessages(initialMessages)} disabled={isBusy} className="border-zinc-700">
                    <RotateCwIcon />
                  </Button>
                </TooltipTrigger>
                <TooltipContent>
          ...
          <CardFooter className="flex-col gap-2 border-t border-zinc-800">
            <form
              onSubmit={(e) => {
                e.preventDefault()
            ...
            >
              <InputGroup>
                <div className="h-14 w-full px-3 py-2.5">
                  <span
                    className="line-clamp-2 opacity-60 data-[status=ready]:opacity-100 text-zinc-100"
                    data-status={status}
                  >
                    {nextMessage ? (
        ...
        <div className="px-0.5 text-center text-xs text-zinc-500">
